...
public:
    ...
    virtual matrix22c_t response(real_t time, real_t freq,
        const vector3r_t &direction, const vector3r_t &direction0, const bool rotate = true) const final override;
    ...
    virtual matrix22c_t elementResponse(real_t time, real_t freq,
        const vector3r_t &direction, const bool rotate = true) const final override;
